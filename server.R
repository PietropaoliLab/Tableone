...
shinyServer(function(input, output, session) {
  ...
  output$tableone <- renderTable({
    ...
    # I made this workaround based on my reply to the issue:
    # https://github.com/mayoverse/arsenal/issues/371
    # In addition, I switched superscript with '( )' since copy-paste in Excel doesn't support superscripts from HTML
